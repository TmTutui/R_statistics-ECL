...
C'est possible d'ajuster un modèle linéaire, mais ce modèle va avoir un performance baisse. 
La cause de ce fait est la difference de quantité entre colomnes et lignes, 
de manoiere que c'est pas possible de determiner tous les coefs de la regression, parce que n_col > n_lingnes
